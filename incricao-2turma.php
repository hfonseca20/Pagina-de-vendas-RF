  ...
  <!--Cabeçario -->
    ...
    <header>
        <div class="container">
            ...
            <div class="text-cabecario">
             <p>Tu Feminina </p> 
            </div>

            <div class="text-cabecario01">
             <h3>Lindona, as inscrições para o Tu Feminina<br>
                estão encerradas, mas, em breve, teremos <br>
                uma nova oportunidade pra ti. </h3> 
            </div>
 
            <div class="row justify-content-center">
                <div class="text-cabecario01">
                    <p class="formatParagrafro" style="">2ª Turma</p>
                </div>
            </div>
            ...
            <div class="row" >
  		        <div class="center01">
                    <div class="text-cabecario03"> 				
                        <h3>Preenche teus dados e serás avisada <br> em primeira mão sobre a próxima turma</h3>
  			        </div>
  		        </div>	
            </div>
		...
		<div class="row center01">
			...
			<div class="col-lg-6 col-sm-8 center01">
                ...
                <form action="https://paginas.rocks/pages/index/467398" method="post" >
                    ...
                    <button class="btn btn-danger btn-page-ebook btn-botao" type="submit">Quero ser avisada</button>
